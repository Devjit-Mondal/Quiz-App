            ...
            R.id.btn_submit->{
                if(mSelectedOptionPosition ==0){
                    ...
                    when{mCurrentPosition <= mQuestionsList!!.size -> {
                        ...
                        val intent = Intent(this, ResultActivity::class.java/*Activity we want to go to*/)
                    ...
                    mSelectedOptionPosition = 0 //otherwise option will stay at same position and we will get wrong
                }
            }
        }
    }
